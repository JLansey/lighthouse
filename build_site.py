    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-about">
          ...
          <div class="social">
            <a href="https://www.facebook.com/pages/NantucketLightshipLV-112/253217448024322" target="_blank" rel="noopener" aria-label="Facebook">f</a>
            <a href="https://www.youtube.com/user/NantucketLV112" target="_blank" rel="noopener" aria-label="YouTube">&#9658;</a>
          </div>
        </div>
        <div>
          <h4>Explore</h4>
...
def side_photo(img, caption, alt=None):
    ...
    cap = f'<div class="side-body"><p class="side-caption">{caption}</p></div>' if caption else ""
